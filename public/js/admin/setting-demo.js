...
var logoLight = "{{ asset('images/kaiadmin/logo_dark.svg') }}";
var logoDark = "{{ asset('images/kaiadmin/logo_dark.svg') }}";

function customCheckColor() {
    var logoHeader = $(".logo-header").attr("data-background-color");

    if (logoHeader !== "white") {
        $(".logo-header .navbar-brand img").attr("src", logoDark);
    } else {
        $(".logo-header .navbar-brand img").attr("src", logoLight);
    }
}
