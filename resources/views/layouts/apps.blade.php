...
<head>
    <meta charset="utf-8" />
    <title>@section('title', 'Industry')</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        <a href="{{url('/')}}" class="navbar-brand ps-5 me-0">
            <h1 class="text-white m-0">Industry</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{route('aboutus')}}"
                    class="nav-item nav-link {{request()->is('aboutus') ? 'active' : ''}}">About</a>
    ...
    <div class="container-fluid copyright bg-dark py-4">
        <div class="container text-center">
            ...
            <p class="mb-0">
                ...
                <a href="https://cloudeyetech.com/">Cloudeyetech.com</a>
            </p>
        </div>
    </div>
    <!-- Copyright End -->
